...
List<NavigationModel> companyMenuDataAdmin = [
  NavigationModel(id: 0, title: "Company"),
  NavigationModel(id: 1, title: "Guest Form"),
  NavigationModel(id: 2, title: "Logs"),
  NavigationModel(id: 3, title: "Create Account"),
  NavigationModel(
    id: 4,
    title: "Update Password",
  ),
];
List<NavigationModel> companyMenuData = [
  NavigationModel(id: 0, title: "Company"),
  NavigationModel(id: 4, title: "Update Password"),
];
